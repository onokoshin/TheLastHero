...
namespace TheLastHero.Services
{
    ...
    public class MockDataStore : IDataStore
    {
        ...
        private MockDataStore()
        {
            ...
            {
                new Monster { Id = Guid.NewGuid().ToString(), Name = "First Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 12, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="HeronLeft.png",UniqueDropID="", xPosition=4,yPosition=0},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Second Monster", Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 15, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="TigerLeft.png",UniqueDropID="", xPosition=4,yPosition=1},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Third Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 2, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="WolfLeft.png",UniqueDropID="", xPosition=4,yPosition=2},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Fourth Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 6, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Human", ImgSource="HawkLeft.png",UniqueDropID= "", xPosition=4,yPosition=3},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Fifth Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 8, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Ghost", ImgSource="SkeletonLeft.png",UniqueDropID="", xPosition=4,yPosition=4},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Sixth Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 11, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Ghost", ImgSource="SkeletonLeft2.png",UniqueDropID= "", xPosition=4,yPosition=5},
            };
