...
namespace TheLastHero.Services
{
    ...
    public class MockDataStore : IDataStore
    {
        ...
        private MockDataStore()
        {
            ...
            {
                new Monster { Id = Guid.NewGuid().ToString(), Name = "First Monster" , Friendly = false, MaxHP = 2000, CurrentHP = 1800, Lvl = 12, Atk=0,Def=10, Spd=9, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="HeronLeft.png", xPosition=4,yPosition=0,demoID=6/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Second Monster", Friendly = false, MaxHP = 523, CurrentHP = 234, Lvl = 15, Atk=0,Def=10, Spd=11, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="TigerLeft.png",xPosition=4,yPosition=1,demoID=7/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Third Monster" , Friendly = false, MaxHP = 1200, CurrentHP = 800, Lvl = 2, Atk=0,Def=10, Spd=5, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="WolfLeft.png",xPosition=4,yPosition=2,demoID=8/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Fourth Monster" , Friendly = false, MaxHP = 900, CurrentHP = 567, Lvl = 6, Atk=0,Def=10, Spd=3, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Human", ImgSource="HawkLeft.png",xPosition=4,yPosition=3,demoID=9/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Fifth Monster" , Friendly = false, MaxHP = 455, CurrentHP = 123, Lvl = 8, Atk=0,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Ghost", ImgSource="SkeletonLeft.png",xPosition=4,yPosition=4,demoID=10/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Sixth Monster" , Friendly = false, MaxHP = 233, CurrentHP = 12, Lvl = 11, Atk=0,Def=10, Spd=7, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Ghost", ImgSource="SkeletonLeft2.png",xPosition=4,yPosition=5,demoID=11/*UniqueDrop= new Item()*/},
            };
            ...
            {
                new Character{ Id = Guid.NewGuid().ToString(), Name = "First Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 12, Atk=99,Def=10, Spd=12, Luk=1, Type="Human", AtkRange=2, CurrentExp=20, CurrentMP=30, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=2 , NextLevelExp=35000, EquippedItem=new Dictionary<Character.Locations, Item>(),ImgSource="KnightRight.png",xPosition=0,yPosition=0,demoID=0},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Second Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 12, Atk=99,Def=10, Spd=6, Luk=1,Type="Human", AtkRange=2, CurrentExp=20, CurrentMP=30, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=2 , NextLevelExp=35000, EquippedItem=new Dictionary<Character.Locations, Item>(),ImgSource="MageRight.png",xPosition=0,yPosition=1,demoID=1},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Third Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 12, Atk=99,Def=10, Spd=10, Luk=1,Type="Human", AtkRange=2, CurrentExp=20, CurrentMP=30, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=2 , NextLevelExp=35000, EquippedItem=new Dictionary<Character.Locations, Item>(),ImgSource="WarriorRight.png",xPosition=0,yPosition=2,demoID=2},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Fourth Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 12, Atk=99,Def=10, Spd=4, Luk=1,Type="Human", AtkRange=2, CurrentExp=20, CurrentMP=30, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=2 , NextLevelExp=35000, EquippedItem=new Dictionary<Character.Locations, Item>(),ImgSource="ArcherRight.png",xPosition=0,yPosition=3,demoID=3},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Fifth Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 12, Atk=99,Def=10, Spd=8, Luk=1,Type="Human", AtkRange=2, CurrentExp=20, CurrentMP=30, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=2 , NextLevelExp=35000, EquippedItem=new Dictionary<Character.Locations, Item>(),ImgSource="FighterRight.png",xPosition=0,yPosition=4,demoID=4},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Sixth Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 12, Atk=99,Def=10, Spd=2, Luk=1,Type="Human", AtkRange=2, CurrentExp=20, CurrentMP=30, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=2 , NextLevelExp=35000, EquippedItem=new Dictionary<Character.Locations, Item>(),ImgSource="ThiefRight.png",xPosition=0,yPosition=5,demoID=5},
