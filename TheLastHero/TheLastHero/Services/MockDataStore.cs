...
namespace TheLastHero.Services
{
    ...
    public class MockDataStore : IDataStore
    {
        ...
        private MockDataStore()
        {
            ...
            {
                new Monster { Id = Guid.NewGuid().ToString(), Name = "First Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 1, Atk=99,Def=0, Spd=9, Luk=1, AtkRange=1, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=1, Type="Beast", ImgSource="HeronLeft.png", xPosition=2,yPosition=0/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Second Monster", Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 1, Atk=99,Def=0, Spd=11, Luk=1, AtkRange=1, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=1, Type="Beast", ImgSource="TigerLeft.png",xPosition=4,yPosition=1/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Third Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 1, Atk=99,Def=0, Spd=5, Luk=1, AtkRange=1, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=1, Type="Beast", ImgSource="WolfLeft.png",xPosition=4,yPosition=2/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Fourth Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 1, Atk=99,Def=0, Spd=3, Luk=1, AtkRange=1, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=1, Type="Beast", ImgSource="HawkLeft.png",xPosition=4,yPosition=3/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Fifth Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 1, Atk=99,Def=0, Spd=1, Luk=1, AtkRange=1, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=1, Type="Ghost", ImgSource="SkeletonLeft.png",xPosition=4,yPosition=4/*UniqueDrop= new Item()*/},
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Sixth Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 1, Atk=99,Def=0, Spd=7, Luk=1, AtkRange=1, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=1, Type="Ghost", ImgSource="SkeletonLeft2.png",xPosition=4,yPosition=5/*UniqueDrop= new Item()*/},
            };
            ...
            {
                new Character{ Id = Guid.NewGuid().ToString(), Name = "First Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 1, Atk=999,Def=0, Spd=12, Luk=1, Type="Human", AtkRange=1, CurrentExp=0, CurrentMP=100, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=3 , NextLevelExp=100, EquippedItem=new Dictionary<ItemLocationEnum, Item>(),ImgSource="KnightRight.png",xPosition=0,yPosition=0},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Second Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 1, Atk=999,Def=0, Spd=6, Luk=1,Type="Human", AtkRange=1, CurrentExp=0, CurrentMP=100, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=3 , NextLevelExp=100, EquippedItem=new Dictionary<ItemLocationEnum, Item>(),ImgSource="MageRight.png",xPosition=0,yPosition=1},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Third Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 1, Atk=999,Def=0, Spd=10, Luk=1,Type="Human", AtkRange=1, CurrentExp=0, CurrentMP=100, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=3 , NextLevelExp=100, EquippedItem=new Dictionary<ItemLocationEnum, Item>(),ImgSource="WarriorRight.png",xPosition=0,yPosition=2},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Fourth Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 1, Atk=999,Def=0, Spd=4, Luk=1,Type="Human", AtkRange=2, CurrentExp=0, CurrentMP=100, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=3 , NextLevelExp=100, EquippedItem=new Dictionary<ItemLocationEnum, Item>(),ImgSource="ArcherRight.png",xPosition=0,yPosition=3},
                new Character{ Id = Guid.NewGuid().ToString(), Name = "Fifth Character", MaxHP = 100, CurrentHP = 100, Friendly = true, Lvl = 1, Atk=999,Def=0, Spd=8, Luk=1,Type="Human", AtkRange=1, CurrentExp=0, CurrentMP=100, IsCapLevel=false, LiveStatus= true, MaxMP=100, MoveRange=3 , NextLevelExp=100, EquippedItem=new Dictionary<ItemLocationEnum, Item>(),ImgSource="FighterRight.png",xPosition=0,yPosition=4},
