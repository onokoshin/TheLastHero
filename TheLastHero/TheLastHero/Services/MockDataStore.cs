    ...
    public class MockDataStore : IDataStore
    {
        ...
        private MockDataStore()
        {
            ...
            var mockMonsters = new List<Monster>
            {
                ...
                new Monster { Id = Guid.NewGuid().ToString(), Name = "Third Monster" , Friendly = false, MaxHP = 100, CurrentHP = 100, Lvl = 2, Atk=99,Def=10, Spd=1, Luk=1, AtkRange=2, CurrentMP=100, Drop=false, LiveStatus=true, MaxMP=100, MoveRange=3, Type="Beast", ImgSource="CatLeft.png",UniqueDropID="", xPosition=4,yPosition=2},
